...
class FieldMapping(models.Model):
    ...
    model_field_id = fields.Many2one(
        comodel_name='ir.model.fields', domain="[('model','=','product.product'),('ttype','in',('char','boolean','text','float','integer','date','datetime','selection'))]")
    field_mapping_id = fields.Many2one(
        comodel_name='field.mappning', help="Field with which you want to map")
