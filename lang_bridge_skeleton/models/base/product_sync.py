		...
		if ctx.get('translation_sync'):
			...
			for langMapObj in langMapObjs:
				...
				ctx_product_dict={lang_ecomm_id:{'name':exup_product_obj.name,
												'description':exup_product_obj.oc_description,
												'tag':exup_product_obj.product_tag,
												'meta_tag_title':exup_product_obj.meta_tag_title,
												'meta_tag_description':exup_product_obj.meta_tag_description,
												'meta_tag_keyword':exup_product_obj.meta_tag_keyword}}
